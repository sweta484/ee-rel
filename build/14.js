...
var CoreSiteHomeIndexPage = /** @class */ (function () {
    ...
    CoreSiteHomeIndexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-core-sitehome-index',template:/*ion-inline-start:"C:\mobapp\moodlemobiledirectory\src\core\sitehome\pages\index\index.html"*/'<ion-header>\n\n    <ion-navbar core-back-button>\n\n        <ion-title>{{ \'core.sitehome.sitehome\' | translate }}</ion-title>\n\n    </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n    <ion-refresher [enabled]="siteHomeComponent && siteHomeComponent.dataLoaded" (ionRefresh)="siteHomeComponent.doRefresh($event)">\n\n        <ion-refresher-content pullingText="{{ \'core.pulltorefresh\' | translate }}"></ion-refresher-content>\n\n    </ion-refresher>\n\n    <core-sitehome-index></core-sitehome-index>\n\n</ion-content>'/*ion-inline-end:"C:\mobapp\moodlemobiledirectory\src\core\sitehome\pages\index\index.html"*/,
        }),
